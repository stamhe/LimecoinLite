...
uint256 hashGenesisBlock("0x000000000e2dca583eb6d3f678cdff807ae6c9c5777ad619f47bc404bd9caa00");
...
const string strMessageMagic = "LimecoinLite Signed Message:\n";
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x000000000e2dca583eb6d3f678cdff807ae6c9c5777ad619f47bc404bd9caa00");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1399843316;
        block.nBits    = 486604799;
        block.nNonce   = 3965581722;
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("LimecoinLiteMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("LimecoinLiteMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("LimecoinLiteMiner started\n");
    ...
    try { loop {
        ...
        printf("Running LimecoinLiteMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("LimecoinLiteMiner terminated\n");
        throw;
    }
}
